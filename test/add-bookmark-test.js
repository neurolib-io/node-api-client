...
describe('AddBookmark', function(){
  ...
  it ('does not fail with existing item and user', (done) => {
    let req, req2, resp;
    req = new rqs.AddBookmark('entity_id','entity_id');
    env.client.send(req)
    .then((res) => {
      done();
    });
  ...
  it ('does not fail with valid timestamp', (done) => {
    let req, req2, resp;
    req = new rqs.AddBookmark('entity_id','entity_id',{'timestamp': '2013-10-29T09:38:41.341Z'});
    env.client.send(req)
    .then((res) => {
      done();
    });
  ...
  it ('fails with nonexisting item id', (done) => {
    let req, req2, resp;
    req = new rqs.AddBookmark('entity_id','nonex_id');
    env.client.send(req)
    .then((res) => {
      chai.fail();
      done();
  ...
  it ('fails with nonexisting user id', (done) => {
    let req, req2, resp;
    req = new rqs.AddBookmark('nonex_id','entity_id');
    env.client.send(req)
    .then((res) => {
      chai.fail();
      done();
