...
describe('RecommendItemsToUser', function(){
  ...
  it ('recommends', (done) => {
    let req, req2, resp;
    req = new rqs.RecommendItemsToUser('entity_id',9);
  ...
  it ('recommends to previously nonexisting entity with cascadeCreate', (done) => {
    let req, req2, resp;
    req = new rqs.RecommendItemsToUser('nonexisting',9,{'cascadeCreate': true});
    env.client.send(req,((err,res) => {
      if(err) {
        chai.fail();
      }
  ...
  it ('recommends with expert settings', (done) => {
    let req, req2, resp;
    req = new rqs.RecommendItemsToUser('nonexisting2',9,{'cascadeCreate': true,'expertSettings': {}});
    env.client.send(req,((err,res) => {
      if(err) {
        chai.fail();
      }
